...
<order>
  ...
  <walletAddress>{supplier_wallet.get_address()}</walletAddress>
  <emissionsData>
...
<shipment>
  <order>
    ...
    <walletAddress>{carrier_wallet.get_address()}</walletAddress>
    <routeOptimization>
...
<transport>
  ...
  <walletAddress>{retailer_wallet.get_address()}</walletAddress>
  <route>
